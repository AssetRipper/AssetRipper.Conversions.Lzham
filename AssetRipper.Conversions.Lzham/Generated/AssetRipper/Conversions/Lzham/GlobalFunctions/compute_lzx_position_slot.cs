...
internal static partial class compute_lzx_position_slot
{
	...
	public unsafe static void Invoke(void* @this, [NativeType("unsigned int")] int dist, [NativeType("unsigned int &")] void* slot, [NativeType("unsigned int &")] void* ofs)
	{
		unchecked
		{
			int num = (((uint)dist >= 4096u) ? (((uint)dist >= 1048576u) ? (((uint)dist >= 16777216u) ? (((uint)dist >= 33554432u) ? (((uint)dist >= 67108864u) ? (52 + (dist - 67108864 >>> 25)) : (50 + (dist - 33554432 >>> 24))) : (48 + (dist - 16777216 >>> 23))) : ((byte)((sbyte*)m_slot_tab2.__pointer)[(uint)(dist >>> 16)])) : ((byte)((sbyte*)m_slot_tab1.__pointer)[(uint)(dist >>> 11)])) : ((byte)((sbyte*)m_slot_tab0.__pointer)[(uint)dist]));
			*(int*)ofs = (dist - ((int*)m_lzx_position_base.__pointer)[(uint)num]) & ((int*)m_lzx_position_extra_mask.__pointer)[(uint)num];
			*(int*)slot = num;
		}
	}
}
