...
internal static partial class lzham_lib_z_compress2
{
	...
	public unsafe static int Invoke([NativeType("unsigned char *")] void* pDest, [NativeType("unsigned long *")] void* pDest_len, [NativeType("unsigned char const *")] void* pSource, [NativeType("unsigned long")] int source_len, [NativeType("int")] int level)
	{
		...
		unchecked
		{
			...
			else
			{
				...
				int num2 = lzham_lib_z_deflateInit.Invoke(&localsPointer->field_0, level);
				...
				{
					int num4 = lzham_lib_z_deflate.Invoke(&localsPointer->field_0, 4);
					if (ExceptionInfo.Current != null)
					{
						return 0;
					}
					...
					if (num3 != 1)
					{
						lzham_lib_z_deflateEnd.Invoke(&localsPointer->field_0);
						if (ExceptionInfo.Current != null)
						{
							return 0;
						}
					...
					else
					{
						*(int*)pDest_len = localsPointer->field_0.total_out;
						int num5 = lzham_lib_z_deflateEnd.Invoke(&localsPointer->field_0);
						if (ExceptionInfo.Current != null)
						{
							return 0;
						}
