...
internal static partial class object_mover_rddqd7
{
	...
	public unsafe static void Invoke([NativeType("void *")] void* pDst_void, [NativeType("void *")] void* pSrc_void, [NativeType("unsigned int")] int num)
	{
		...
		unchecked
		{
			void* ptr2 = (byte*)ptr + (nint)(uint)num * (nint)sizeof(lzham_lzcompressor_lzpriced_decision);
			void* ptr3 = pDst_void;
			while (ptr != ptr2)
			{
				llvm_memcpy_p0_p0_i64.Invoke(ptr3, ptr, 24L, isVolatile: false);
				ptr = (byte*)ptr + sizeof(lzham_lzcompressor_lzpriced_decision);
				ptr3 = (byte*)ptr3 + sizeof(lzham_lzcompressor_lzpriced_decision);
			}
		}
	}
}
