...
internal static partial class print_zz7k6m
{
	...
	public unsafe static void Invoke(void* @this)
	{
		unchecked
		{
			...
			{
				printf.Invoke(String_npt3bn.__pointer, default(ReadOnlySpan<nint>));
				printf.Invoke(String_rx79g7.__pointer, default(ReadOnlySpan<nint>));
				_ = ((lzham_lzcompressor_coding_stats*)@this)->m_total_update_rate_resets;
				printf.Invoke(String_yv8y8d.__pointer, default(ReadOnlySpan<nint>));
				...
				printf.Invoke(String_f4ahxf.__pointer, default(ReadOnlySpan<nint>));
				...
				printf.Invoke(String_vudj64.__pointer, default(ReadOnlySpan<nint>));
				printf.Invoke(String_timpwh.__pointer, default(ReadOnlySpan<nint>));
				...
				_ = ((lzham_lzcompressor_coding_stats*)@this)->m_total_contexts;
				printf.Invoke(String_e29b4t.__pointer, default(ReadOnlySpan<nint>));
				...
				printf.Invoke(String_9b8hig.__pointer, default(ReadOnlySpan<nint>));
				...
				printf.Invoke(String_i6ccyf.__pointer, default(ReadOnlySpan<nint>));
				printf.Invoke(String_xa9qi5.__pointer, default(ReadOnlySpan<nint>));
				...
				printf.Invoke(String_fague4.__pointer, default(ReadOnlySpan<nint>));
				printf.Invoke(String_yaa426.__pointer, default(ReadOnlySpan<nint>));
				...
				printf.Invoke(String_fague4.__pointer, default(ReadOnlySpan<nint>));
				printf.Invoke(String_jnf25f.__pointer, default(ReadOnlySpan<nint>));
				...
				printf.Invoke(String_kn3w39.__pointer, default(ReadOnlySpan<nint>));
				printf.Invoke(String_dpnkqw.__pointer, default(ReadOnlySpan<nint>));
				...
				{
					printf.Invoke(String_8n44gc.__pointer, default(ReadOnlySpan<nint>));
				...
				for (int j = 2; (uint)j <= 257u; j++)
				{
					...
					printf.Invoke(String_cijmf9.__pointer, default(ReadOnlySpan<nint>));
				}
				...
				printf.Invoke(String_wgkvsw.__pointer, default(ReadOnlySpan<nint>));
				_ = ((lzham_lzcompressor_coding_stats*)@this)->m_total_truncated_matches;
				_ = ((lzham_lzcompressor_coding_stats*)@this)->m_total_matches;
				printf.Invoke(String_id92h6.__pointer, default(ReadOnlySpan<nint>));
				_ = ((lzham_lzcompressor_coding_stats*)@this)->m_max_len2_dist;
				printf.Invoke(String_r7bdmb.__pointer, default(ReadOnlySpan<nint>));
			}
		}
	}
}
