...
internal static partial class try_resize_no_construct_e6uwjm
{
	...
	public unsafe static bool Invoke(void* @this, [NativeType("unsigned int")] int new_size, [NativeType("bool")] bool grow_hint)
	{
		...
		unchecked
		{
			...
			{
				bool flag = increase_capacity_hfvvuj.Invoke(@this, new_size, (new_size != ((lzham_vector*)@this)->m_size + 1) ? ((b & 1) == 1) : true, nofail: true);
